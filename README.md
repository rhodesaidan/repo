...
A toy is the player's open ended object that respond to their interactions and inputs, where new patterns and dynamics can be discovered through ongoing usage and mastery. On the other hand, a game is a structural field providing rules and goals intended to direct the player into using the toy for. 
...
Difficulty is not a fixed property of a game, as it depends on the player's experience on the type of genre and mechanics. It also varies on their learning ability, and their ability to adapt from their surroundings. All in all, the difficulty of a game relies on the player's experience and intellect.
